...
// Override with VITE_GENERATE_SHIP_URL and VITE_WS_URL when needed.
...
const PROD_WS_URL = "wss://space-ship-socket.benlirio.com:8080";
...
// Helper for logging current config (optional)
